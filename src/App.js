...
function App() {
    ...
    return (
        <div className="App">
            ...
            <button style={{background:"blue"}} className='loginLogoutBtn' onClick={()=> setIsLogin(!isLogin)}> { isLogin ? "Logout" : "Login" }</button>
            <hr></hr> */}
            {/* <h1 style={{color:"green"}}>List View</h1>
            <Listview /> */}
            
            {/* <h1 style={{color:"yellow"}} >Create modal for Login and Registration</h1>
            <LoginRegModal /> */}
