...
const LoginRegModal = () => {
    ...
    return (
        <div>
            ...
            <button style={{background:"yellow",color:"black"}}  onClick={() => toggleModal('login')}>Click to Open</button>
            <h3>Registration Form Modal</h3>
            <button style={{background:"yellow",color:"black"}}  onClick={() => toggleModal('register')}>Click to Open</button>
            {modal && (
                <div className="modal">
